...
abstract class Entity extends Location implements Metadatable
{
    ...
    public static function init()
    {
        ...
        $content = file_get_contents($file = Server::getInstance()->getFilePath() . "src/pocketmine/resources/entities.json");

        $content = json_decode($content, true);

        foreach($content as $l){
            Server::getInstance()->getLogger()->info(TextFormat::LIGHT_PURPLE."Registering entity: ".$l['name']);
            self::$entity[$l['name']] = [
                "name" => $l['name'],
